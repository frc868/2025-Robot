...
public class HoundBrian {
        ...
        private final DigitalInput elevatorButton = new DigitalInput(0);
        private final DigitalInput pivotButton = new DigitalInput(0);
